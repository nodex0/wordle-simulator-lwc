(function () {
    ...
    const $fragment1$1 = parseFragment`<span${"c0"}${2}>${"t1"}</span>`;
    function tmpl$1($api, $cmp, $slotset, $ctx) {
      const {ncls: api_normalize_class_name, k: api_key, d: api_dynamic_text, sp: api_static_part, st: api_static_fragment, b: api_bind, h: api_element, i: api_iterator} = $api;
      const {_m0, _m1, _m2} = $ctx;
      return api_iterator($cmp.renderableWord, function (letter) {
        return [!$cmp.isEditable ? api_static_fragment($fragment1$1, api_key(1, letter.index), [api_static_part(0, {
          className: api_normalize_class_name(letter.classes)
        }, null), api_static_part(1, null, api_dynamic_text(letter.character))]) : null, $cmp.isEditable ? api_element("span", {
          className: api_normalize_class_name(letter.classes),
          key: api_key(2, letter.index)
        }, [api_element("input", {
          attrs: {
            "type": "text",
    ...
    tmpl$1.stylesheets = [];
    tmpl$1.stylesheetToken = "lwc-22vudulnpst";
    tmpl$1.legacyStylesheetToken = "ui-wordDisplay_wordDisplay";
    ...
    class WordDisplay extends LightningElement {
      ...
      handleChange(event) {
        ...
        allInputs.map(input => input.value === '' ? '#' : input.value);
      }
      handleClick(event) {
        const index = parseInt(event.target.dataset.index);
    ...
    const __lwc_component_class_internal$3 = registerComponent(WordDisplay, {
      tmpl: _tmpl$2,
      sel: "ui-word-display",
      apiVersion: 62
    });

    const $fragment1 = parseFragment`<h1 class="title${0}"${2}>${"t1"}</h1>`;
    const $fragment2 = parseFragment`<option${"a0:value"}${3}>${"t1"}</option>`;
    const $fragment3 = parseFragment`<span class="pool-word${0}"${2}>${"t1"}</span>`;
    const $fragment4 = parseFragment`<h3${3}>${"t1"}</h3>`;
    const $fragment5 = parseFragment`<p${3}>${"t1"}</p>`;
    const stc0 = {
      classMap: {
        "container": true
      },
    ...
    function tmpl($api, $cmp, $slotset, $ctx) {
      const {d: api_dynamic_text, sp: api_static_part, st: api_static_fragment, t: api_text, b: api_bind, k: api_key, i: api_iterator, h: api_element, c: api_custom_element} = $api;
      const {_m0, _m1, _m2} = $ctx;
      return [api_element("div", stc0, [api_static_fragment($fragment1, 2, [api_static_part(1, null, api_dynamic_text($cmp.labels.appTitle))]), api_element("div", stc1, [api_element("label", stc2, [api_text(api_dynamic_text($cmp.labels.dictionary) + " " + api_dynamic_text($cmp.dictionaryFile)), api_element("select", {
        key: 5,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.handleLanguageChange))
        }
      }, api_iterator($cmp.languages, function (language) {
        return api_static_fragment($fragment2, api_key(7, language.value), [api_static_part(0, {
          attrs: {
            "value": language.value
          }
        }, null), api_static_part(1, null, api_dynamic_text(language.label))]);
      }))])]), api_element("div", stc3, [api_element("div", stc4, api_iterator($cmp.moves, function (move) {
        return api_element("div", {
          classMap: stc5,
          key: api_key(10, move.index)
        }, [api_custom_element("ui-word-display", __lwc_component_class_internal$3, {
          props: {
            "word": move.word,
            "result": move.result,
      ...
      })), $cmp.pool ? api_element("div", stc6, api_iterator($cmp.pool, function (word) {
        return api_static_fragment($fragment3, api_key(14, word), [api_static_part(1, null, api_dynamic_text(word))]);
      })) : null]), api_element("div", stc7, [api_element("div", stc8, [api_static_fragment($fragment4, 18, [api_static_part(1, null, api_dynamic_text($cmp.labels.newWordTitle))]), api_static_fragment($fragment5, 20, [api_static_part(1, null, api_dynamic_text($cmp.labels.newWordDescription))]), api_custom_element("ui-word-display", __lwc_component_class_internal$3, {
        props: {
          "characters": $cmp.characters,
          "isEditable": "true"
        },
      ...
      })]), api_element("div", stc9, [api_element("input", {
        attrs: {
          "type": "button",
    ...
    const __lwc_component_class_internal$2 = registerComponent(getDirectory, {
      tmpl: _tmpl,
      sel: "wires-wire-get-directory-provider",
      apiVersion: 62
    });
    ...
    const __lwc_component_class_internal$1 = registerComponent(getDictionary, {
      tmpl: _tmpl,
      sel: "wires-wire-get-dictionary-provider",
      apiVersion: 62
    });
    ...
    registerDecorators(App, {
      wire: {
        _directoryWire: {
          adapter: __lwc_component_class_internal$2,
          method: 1,
          config: function ($cmp) {
            return {};
          }
        ...
        _dictionaryWire: {
          adapter: __lwc_component_class_internal$1,
          dynamic: ["file"],
          method: 1,
          config: function ($cmp) {
            return {
